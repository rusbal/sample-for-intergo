...
@section('top')
    <tr>
        <td style="text-align:left; padding: 20px;">
            <a style="text-decoration: none; color: white;" href="{{ url('/my/reports/price-violations') }}">VIEW IN BROWSER</a>
        </td>
...
@section('content')
    <tr>
        <td style="text-align: center;">
            <h1 style="color: #87d9bf; margin: 0 0 10px; font-size: 1.5em;">PRICE VIOLATIONS</h1>
