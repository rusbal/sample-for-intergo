                ...
                <div class="widget clearfix m-t-40">
                    <div class="widget-left-container">
                        <ol class="li-m-b-10 font-em-05">
                            ...
                            <li>For "Application Name" enter <strong>{!! env('APP_NAME') !!}</strong> and for "Application's Account Number" enter <strong>{!! env('AMAZON_DEVELOPER_ACCOUNT_NUMBER') !!}</strong></li>
